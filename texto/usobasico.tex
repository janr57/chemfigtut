...
Empezaremos describiendo el comando en general:
\begin{center}
  {\small
...
\item \texttt{<carga>}: Cualquier elemento arbitrario que rodea a los átomos, con pocas
  ...
  incluso una molécula \texttt{\textbackslash chemconfig}.

\item \texttt{<parámetros opcionales>}: Pares \emph{clave}/\emph{valor} que que usarán
  al utilizar esa macro.
...
\item \texttt{<código tikz>}: Código que se aplica a la \emph{carga}.
\end{itemize}
...
longitud adicional entre la caja del átomo y la carga, que a menos que se indique otra
cosa en \texttt{código tikz}, sería el centro de la carga.
...
\begin{center}
  \begin{longtable}{rcl}\hline
    ...
    & Booleano, que cuando es \texttt{true}, representa en\\&&
      ...
      los átomos; en azul, las cajas, y la carga en rojo\\
...
\vspace{-5ex}
Es posible fijar algunos de los valores anteriores mediante:
\begin{center}
  \texttt{\textbackslash setcharge\{<clave>=<valor>\}}
\end{center}

En cualquier momento se pueden restaurar los valores por defecto mediante
\begin{center}
...
\texttt{\textbackslash setcharge\{...\}}, recordando que se puede revertir a la
configuración de \texttt{\textbackslash charge} por defecto de \textsf{chemfig}
utilizando después \texttt{\textbackslash resetcharge}:
...
\vspace{1ex}
Pares de electrones solitarios representados por una línea, según los valore por
defecto de \texttt{\textbackslash charge} en \texsf{chemfig}:
...
\begin{tabular}{|c|}\hline
  \vphantom{\rule{0.1pt}{3ex}}
  {\large\chemfig{\charge{90:1.3pt=\|[|style={line width=1.1pt}]}{N}H_3}}\\
  \texttt{%
  \{\textbackslash charge\ttres{\{90:1.3pt=\textbackslash:\ttresg{[|style=\{line width=1.1pt\}]}\}\{N\}}H\_3\}
  }
  \\[0.5ex]
  \hline
\end{tabular}
...
\begin{tabular}{|c|}\hline
  \vphantom{\rule{0.1pt}{3ex}}
  {\large\chemfig{\charge{180:1.3pt=\|[|style={line width=1.1pt}]}{N}H_3}}\\
  \texttt{%
  \{\textbackslash charge\ttres{\{180:1.3pt=\textbackslash:\ttresg{[|style=\{line width=1.1pt\}]}\}\{N\}}H\_3\}
  }
  \\[0.5ex]
  \hline
\end{tabular}
...
\setcharge{|style={draw=red,line width=1.1pt}}
\begin{tabular}{|c|c|}\hline
  \multicolumn{2}{|c|}{\ttresg{%
  \textbackslash setcharge\{|style=\{draw=red,line width=1.1pt\}\}
  }}\\\hline
...
\vspace{1ex}
Como último ejemplo veremos otra forma de representar un par de electrones solitarios:
...
%\begin{tabular}{|c|c|}\hline
%  \vphantom{\rule{0.1pt}{3ex}}
%  {\large\chemfig{\chargeline{{90:2pt}{N}H_3}}}
